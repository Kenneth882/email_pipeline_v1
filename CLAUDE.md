...
| 3–4 | Drip Engine: quota, warm-up, follow-ups, suppression-at-send-time, bounce pause, kill switch, `outbound_messages` writes, reference token in template — via Unipile | Dry-run logs intended sends; live test to 5 seeds; a reply suppresses its own follow-up; sends thread correctly |
